...
export const metadata = {
  title: 'spitxxx bp sexy video bravotube brazzers3x brezzar comxxx blueflim | spitxxx',
  description: 'boobs kiss bravotube boobs pressing blueflim brazzers3x dasi sex dehati sex brezzar bfxxx comxxx bf sexy banglaxx beeg hindi blueflim auntymaza adult movies | spitxxx',
...
export default async function MuslimPage({ searchParams }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {page > 1 && (
        <div className="mb-6">
          <h1 className="text-2xl font-semibold">Muslim Videos - Page {page}</h1>
      ...
      {page === 1 && (
        <ExpandableContent 
          title="About Muslim Porn Videos"
          content={generateCategoryContent('Muslim', list, totalRecords)}
